...
if __name__ == '__main__':
    ...
    if args.do_train:
        ...
        best_f1 = 0
        # if args.local_rank in [-1, 0]:
        #     best_f1, best_em, best_f1_em = evaluate(model_base, args, dev_examples, dev_features, device,
    ...
    if args.do_predict:
        ...
        if model_path.endswith('.pth') or \
            ...
            for path in model_path:
                # utils.torch_init_model(model_base, path)
        ...
        # test(model_base, args, dev_examples, dev_features, device)
