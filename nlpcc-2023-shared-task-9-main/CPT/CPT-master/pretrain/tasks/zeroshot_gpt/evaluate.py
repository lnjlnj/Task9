...
# These are needed to unwrap the model_base, would be nice to put these in megatron.utils if possible?
...
def get_model_provider(eval_metric):
    ...
    return the model_base provider."""
    ...
    def model_provider(pre_process=True, post_process=True):
        ...
        print_rank_0('building GPT model_base ...')
...
def forward_step(batch, model, eval_metric):
    ...
    # Tell the model_base what our actual batch size will be
    args = get_args()
...
def main():
    ...
    # Set up model_base and load checkpoint.
