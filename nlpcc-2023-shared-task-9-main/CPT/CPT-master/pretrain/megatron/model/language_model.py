...
"""Transformer based language model_base."""
...
def get_language_model(num_tokentypes, add_pooler,
    ...
    """Build language model_base and return along with the key to save."""
    args = get_args()
...
class Embedding(MegatronModule):
    """Language model_base embeddings.
    ...
    def __init__(self,
        ...
        # method call so we can load a pretrain model_base without
    ...
    def add_tokentype_embeddings(self, num_tokentypes):
        ...
        token-type embeddings in case the pretrained model_base does not have it.
        This allows us to load the model_base normally and then add this embedding.
        """
...
class TransformerLanguageModel(MegatronModule):
    """Transformer language model_base.
