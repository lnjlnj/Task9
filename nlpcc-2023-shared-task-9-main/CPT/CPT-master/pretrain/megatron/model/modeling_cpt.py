...
""" PyTorch CPT model_base. modified from transformers==4.4.1"""
import copy
import math
import random
import warnings
...
# For cuda fused ops
# from megatron.model_base import LayerNorm
# from megatron.model_base.transformer import ParallelMLP
# from megatron.model_base.fused_bias_gelu import bias_gelu_impl
# from megatron import mpu
# from megatron import get_args
# from megatron.model_base.enums import AttnMaskType, LayerType, AttnType
...
@add_start_docstrings(
    """
    CPT model_base with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
    tasks.
    """,
    CPT_START_DOCSTRING,
)
