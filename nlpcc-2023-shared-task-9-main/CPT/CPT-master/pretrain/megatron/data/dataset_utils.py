...
DSET_TYPES = [DSET_TYPE_BERT, DSET_TYPE_ICT, DSET_TYPE_T5, 'bart', 'cpt']
...
def _build_train_valid_test_datasets(data_prefix, data_impl, splits_string,
    ...
    def print_split_stats(name, index):
        ...
        # Override the num samples
        # train_valid_test_num_samples[index] = (end_index - start_index)
    ...
    def build_dataset(index, name):
        ...
        from megatron.data.bart_dataset import BartDataset
        from megatron.data.cpt_dataset import CPTDataset
        dataset = None
...
def get_samples_mapping(indexed_dataset,
    ...
    # device_index=rank which is not the case for model_base
    # parallel case
